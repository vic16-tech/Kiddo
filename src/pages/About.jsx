...
export default function About() {
  ...
  const missionStatsData = [
    { name: 'Active Young Learners', value: 1100, suffix: '+' },
    { name: 'Fun Learning Activities', value: 500, suffix: '+' },
    { name: 'Skills Mastered', value: 99.9, suffix: '%', decimalPlaces: 1 },
    { name: 'Global Impact Countries', value: 25, suffix: '+' }, // Added new stat
  ];
