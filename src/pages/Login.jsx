...
export default function LoginPage() {
  ...
  const BACKGROUND_IMAGE_URL = "/signup1.jpg"; // Using the same background as signup for consistency
  ...
  return (
    ...
    <div className="relative bg-gray-950 font-rob min-h-screen font-rob overflow-hidden pt-20">
      {/* Background Image */}
      <img
      ...
      >
        {/* NEW WRAPPER FOR GLOW EFFECT (similar to SignUpPage) */}
              ...
              <div className="rounded-md shadow-sm"> {/* Removed -space-y-px for better spacing */}
                ...
                <div className="relative"> {/* Added relative positioning for the icon */}
                  ...
                  <input
                    ...
                    required
                    className={`appearance-none relative block w-full px-4 py-3 border border-gray-600 rounded-md placeholder-gray-400 text-white bg-gray-700/70 pr-10
                                focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm
